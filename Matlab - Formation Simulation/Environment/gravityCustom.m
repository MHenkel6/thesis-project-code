function [gx, gy, gz]= gravityCustom( p)
...
degree =  Constants.graviPar.degree;
C =  Constants.graviPar.C;
S =  Constants.graviPar.S;
checkinputs();

% set default values
model  = 'EGM2008';
action = 'warning';
maxdeg = Constants.maxDegree; % Change to 120 for proper data generation
